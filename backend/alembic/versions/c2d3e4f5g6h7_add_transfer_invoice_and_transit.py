...
def upgrade():
    ...
    with op.batch_alter_table('items') as batch_op:
        batch_op.add_column(sa.Column('transfer_invoice_number', sa.String(), nullable=True))
        batch_op.add_column(sa.Column('transfer_invoice_series', sa.String(), nullable=True))
        batch_op.add_column(sa.Column('transfer_invoice_date', sa.DateTime(), nullable=True))
